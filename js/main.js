...
(function () {
    ...
    // =============================================
    // Default Project Data (fallback if PHP data not available)
    // =============================================
    ...
    // Use PHP-provided data or fallback to default
    const getProjectsData = () => {
        return typeof projectsData !== 'undefined' ? projectsData : defaultProjectsData;
    };
